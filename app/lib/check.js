...
module.exports = {
  checkNum, // 检查输入的一串字符是否全部是数字
  checkDecimal, // 检查输入的一串字符是否为小数
  checkInteger, // 检查输入的一串字符是否为整型数据
  checkStr, // 检查输入的一串字符是否是字符
  checkChinese, // 检查输入的一串字符是否包含汉字
  checkEmail, // 检查输入的邮箱格式是否正确
  checkMobilePhone, // 检查输入的手机号码格式是否正确
  checkTelephone, // 检查输入的固定电话号码是否正确
  checkMobilePhoneOrTelephone, // 检查输入是否手机或者座机号码
  checkQQ, // 检查QQ的格式是否正确
  checkCard, // 检查输入的身份证号是否正确
  checkIP, // 检查输入的IP地址是否正确
  checkURL, // 检查输入的URL地址是否正确
  checkQuote, // 检查输入的字符是否具有特殊字符
  checkDate, // 检查日期格式是否正确
